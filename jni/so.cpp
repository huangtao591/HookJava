#include <jni.h>
#include <com_k_hookjava_hookLib.h>
...
extern "C"{
#endif
JNIEXPORT jstring JNICALL test
  (JNIEnv * jenv, jclass jcls){
	return jenv->NewStringUTF("this is so hook java!");
}
#ifdef __cplusplus
}
#endif
...
HookInfo hookInfos[] = {
		{"com/k/hookjava/MainActivity","test","()Ljava/lang/String;",(void*)test},
...
JNIEXPORT jstring JNICALL Java_com_k_hookjava_hookLib_test
  (JNIEnv * jenv, jclass jcls){
	Hook();
	return jenv->NewStringUTF("JNI test");
}
